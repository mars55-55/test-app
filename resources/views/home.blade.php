    ...
    <div class="row">
        <div class="col-md-4 text-center">
            <div class="benefit-card p-4 shadow-sm rounded">
                <img src="/images/fresh-produce.jpg" alt="Productos Frescos" class="benefit-icon mb-3 img-fluid">
        ...
        <div class="col-md-4 text-center">
            <div class="benefit-card p-4 shadow-sm rounded">
                <img src="/images/fair-trade.jpg" alt="Comercio Justo" class="benefit-icon mb-3 img-fluid">
        ...
        <div class="col-md-4 text-center">
            <div class="benefit-card p-4 shadow-sm rounded">
                <img src="/images/technology.jpg" alt="Tecnología" class="benefit-icon mb-3 img-fluid">
